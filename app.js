...
function callback(results, status){
    ...
    for(var i = 0; i < results.length; i++){
        ...
        if((!photoForPlace) || (photoForPlace === undefined)){
            ...
            $('.results').append("<li><div class='food-thumbnail'><img style='height:190px;min-width: 230px;' value = '"+i+"' src='"+photoForPlace+"'></div><div class='resultName'>"+placeName+"</div><div class='location'>"+longName+"</div></li>");
        }
